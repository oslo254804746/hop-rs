...
- **[v0.1.6 发布说明](docs/releases/v0.1.6.zh-CN.md)**
- **[文档索引](docs/README.md)**
...
v0.1.6 会在首次启动时应用所有待执行的数据库迁移，并保留现有资产、凭据、SSH Key、Known Hosts 和管理员密码。从 v0.1.5 升级不包含新的数据库迁移；从 v0.1.4 直接升级后，迁移后的数据库不能直接交给 v0.1.4 使用。
...
4. 启动 v0.1.6 后检查日志、Admin 登录和一条真实 SSH 路径。
