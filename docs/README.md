...
- [管理面板交付契约](product/management-panel-v0.2.md)
...
These documents define current behavior and take precedence over historical plans:

- [Hop product direction](product/product-direction-v0.2.md)
...
- [Management-panel delivery boundary](product/management-panel-v0.2.md)
